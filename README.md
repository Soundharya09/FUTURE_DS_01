...
- Highlight best and worst-performing products, segments, and regions.
- Understand customer purchasing behavior and shipping habits.
- Build a user-friendly, interactive Power BI dashboard.
- Present insights clearly using strong visual storytelling.

Ultimately, it helps answer high-impact business questions like:
...
Key Fields:
- Orders: Order ID, Order/Ship Date, Ship Mode
- Customers: Customer ID, Name, Segment
- Products: Product ID, Category, Sub-Category, Name
...
- Customer Count: 793
- Trends: Sales and profit patterns reveal seasonality and overall health.
- Top States by Sales: California and New York dominate, with Texas and Washington close behind.
...
Key Visuals:
- Year-over-Year Comparison (2011–2014).
- Monthly Trend Lines to spot seasonal peaks.
- Category & Sub-Category Breakdown:
    - Technology & Office Supplies dominate sales.
    - Furniture shows fluctuating profit margins.
...
- 531 Cities
- 49 States
- Top Customers by Quantity: Jonathan, William, John, and Paul lead in purchase volume.
- Product Profitability:
    - Most profitable: Canon imageCLASS 2200 ($25.2K).
    - Largest losses: Bush Cubix & Cubify CubeX.
- Customer Segments:
    - Consumer — 51.94%
    - Corporate — 30.22%
    - Home Office — 17.84%
- Shipping & Category Preferences:
    - Standard Class accounts for 59.72% of shipments.
    - Office Supplies make up 60% of overall sales volume.
...
2. Data Modeling
- Built relationships across Orders, Customers, Products, and Regions.
- Created custom DAX measures for KPIs, including Sales, Quantity, and Profit Margin.

3. Visualization & Interactivity
- Slicers for Year, Region, Category, and Sub-Category.
- Crafted charts: bar, donut, line, KPI cards, and maps.
- Designed an intuitive layout and user experience.
...
- Understand performance trends across time and geography.
- Identify new growth opportunities and optimize cost drivers.
